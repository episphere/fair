 ...
 * Next session is <span style="background-color:yellow">[March 19<sup>th</sup>](https://sites.google.com/view/fair-data/2021/2021-03-19-mar)</span>:
   <br><i>API study: Polygenic Risk Scores using <a href="https://www.pgscatalog.org" target="_blank">pgscatalog.org</a>; Reading remote compressed files FAIRly; intro to TCGA, ICGC usecases</i>
